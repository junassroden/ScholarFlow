...
<body class="font-body bg-brand-bg text-brand-text antialiased min-h-screen flex">
    ...
    <aside class="w-64 bg-white border-r border-brand-border flex flex-col justify-between hidden md:flex">
        <div>
            ...
            <div class="p-6 border-b border-brand-border">
                <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-2 font-heading text-xl font-bold text-brand-500">
            ...
            <nav class="p-4 space-y-1">
                <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center gap-3 px-4 py-2.5 text-sm font-medium rounded-lg bg-blue-50 text-brand-500">
                    <span>📊</span> Dashboard
                </a>
        ...
        <div class="p-4 border-t border-brand-border">
            <div class="flex items-center gap-3 mb-3 px-2">
                ...
                <div class="overflow-hidden">
                    <p class="text-sm font-bold text-brand-text truncate"><?php echo e($userName); ?></p>
                    <p class="text-xs text-brand-muted truncate"><?php echo e($userEmail); ?></p>
                </div>
            </div>
    ...
    <main class="flex-1 flex flex-col min-w-0">
        ...
        <header class="bg-white border-b border-brand-border h-16 flex items-center justify-between px-6">
            <h1 class="font-heading text-lg font-bold text-brand-text">Welcome back, <?php echo e($userName); ?>! 👋</h1>
...
</html><?php /**PATH C:\laragon\www\scholarflow\resources\views/dashboard.blade.php ENDPATH**/ ?>
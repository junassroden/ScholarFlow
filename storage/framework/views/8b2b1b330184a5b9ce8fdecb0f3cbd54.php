...
<div class="w-full max-w-md bg-white rounded-2xl shadow-xl border border-slate-200 p-8">
    ...
    <div class="text-center mb-8">
        ...
        <a href="<?php echo e(route('home')); ?>" class="text-3xl font-bold text-blue-600">
            📘 ScholarFlow
        </a>
...
</html><?php /**PATH C:\laragon\www\scholarflow\resources\views/auth/login.blade.php ENDPATH**/ ?>
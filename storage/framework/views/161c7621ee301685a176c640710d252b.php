        ...
        <form action="<?php echo e(route('register.post')); ?>" method="POST" class="space-y-4">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="first_name" value="<?php echo e(old('first_name')); ?>"
                        required
                        class="w-full px-3 py-2 border border-slate-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-600">
                </div>
                <div>
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="phone" placeholder="09123456789"
                        value="<?php echo e(old('phone')); ?>" required pattern="09[0-9]{9}"
                        class="w-full px-3 py-2 border border-slate-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-600">
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="email" name="email_confirmation"
                        value="<?php echo e(old('email_confirmation')); ?>" required
                        class="w-full px-3 py-2 border border-slate-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-600">
                </div>
            </div>
            ...
            <div class="flex items-center pt-2">
                ...
                <label for="terms" class="ml-2 text-xs text-slate-600">
                    I agree to the <a href="#" class="text-blue-600 underline">Terms & Conditions</a> and <a href="#"
                        class="text-blue-600 underline">Privacy Policy</a>.
                </label>
            </div>

            <button type="submit"
                class="w-full py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg text-sm shadow-sm transition-colors mt-2">
                Create Account
            </button>
        </form>

        <p class="text-center text-sm text-slate-500 mt-6">
            Already have an account?  <a href="<?php echo e(route('login')); ?>" class="text-blue-600 font-semibold hover:underline">Login</a>
        </p>
    </div>
...
</html><?php /**PATH C:\laragon\www\scholarflow\resources\views/auth/register.blade.php ENDPATH**/ ?>
    ...
    <nav id="navbar" class="fixed top-0 left-0 w-full z-50 transition-all duration-300 bg-transparent py-4">
        <div class="max-w-7xl mx-auto px-6 flex justify-between items-center">
            ...
            <div class="hidden md:flex items-center gap-4">
                <a href="<?= url('/login') ?>" class="px-4 py-2 text-sm font-medium text-brand-text hover:text-brand-500">Login</a>
                <a href="<?= url('/create') ?>" class="px-5 py-2.5 text-sm font-medium text-white bg-brand-500 hover:bg-brand-600 rounded-lg shadow-sm transition-all">Create Account</a>
            </div>
        </div>
    </nav>
        ...
        <div class="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
            <div>
                ...
                <div class="flex gap-4">
                    <a href="<?= url('/create') ?>" class="px-6 py-3 bg-brand-500 hover:bg-brand-600 text-white font-medium rounded-lg shadow-md transition-all">Get Started</a>
